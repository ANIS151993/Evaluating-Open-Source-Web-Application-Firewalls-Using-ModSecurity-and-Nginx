...
This work is part of a broader research program on Layer-7 threat detection; a companion study by the authors investigated a serverless, cross-cloud intelligent firewall combining a Zero-Trust control plane with AI-driven detection \cite{chowdhury2026serverless}, and the present paper complements that direction by targeting organizations that self-host their infrastructure and cannot rely on managed cloud security services.
