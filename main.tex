...
% TikZ styles for the system architecture diagram (Fig. 5) -- the only
% remaining inline TikZ figure; all other diagrams use pre-rendered images
% in figures/ for faster, more portable compilation.
...
This work is part of a broader research program on Layer-7 threat detection; a companion study by the authors investigated a serverless, cloud-native intrusion-prevention architecture \cite{chowdhury2025serverless}, and the present paper complements that direction by targeting organizations that self-host their infrastructure and cannot rely on managed cloud security services.
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig1_waf_taxonomy.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig2_modsec_pipeline.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig3_crs_scoring.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig4_dsr_flow.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig6_tuning_workflow.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig7_detection_rates.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig8_fp_reduction.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig9_latency_scaling.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig10_cpu_scaling.png}
...
\begin{IEEEbiographynophoto}{Md Anisur Rahman Chowdhury}
is a graduate researcher in the Dept. of Computer and Information Science at
Gannon University, USA. His research focuses on open-source and cloud-native
Layer-7 security, including web application firewalls and serverless
intrusion-prevention architectures. He maintains reproducible research
artifacts for his published work at \url{github.com/ANIS151993}.
\textit{[Author: please review/replace this biography with your preferred
wording before final submission.]}
\end{IEEEbiographynophoto}

\begin{IEEEbiographynophoto}{Samuel Tweneboah-Koduah, Ph.D.}
is with the Dept. of Computer and Information Science at Campbellsville
University, USA.
\textit{[Co-author: please supply a biography paragraph before final
submission.]}
\end{IEEEbiographynophoto}
